# = ===================================================
#CREATE_PROJECT_INFO = 20140912162119
...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
CALENDAR_APP_SUPPORT = yes
CUSTOM_BUILD_VERNO = 
CUSTOM_CLIENT_ID = android-panasonic
CUSTOM_HAL_04_IMGSENSOR = 
CUSTOM_HAL_04_SUB_IMGSENSOR = 
...
CUSTOM_HAL_IMGSENSOR = ov13850_mipi_raw_s35_sunwin ov5670_mipi_raw_s35 gc2355_mipi_raw_s35
CUSTOM_HAL_LENS = dummy_lens fm50af dw9718af
CUSTOM_HAL_MAIN2_IMGSENSOR = 
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = 
CUSTOM_HAL_MAIN_BACKUP_LENS = dummy_lens
CUSTOM_HAL_MAIN_IMGSENSOR = ov13850_mipi_raw_s35_sunwin
CUSTOM_HAL_MAIN_LENS = fm50af dw9718af
CUSTOM_HAL_MSENSORLIB = 
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB2_IMGSENSOR = 
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = gc2355_mipi_raw_s35
CUSTOM_HAL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_HAL_SUB_IMGSENSOR = ov5670_mipi_raw_s35
CUSTOM_HAL_SUB_LENS = 
CUSTOM_INTERNAL_VERSION = S3569_DS35691_KARBONN_L103
CUSTOM_KERNEL_04_IMGSENSOR = 
CUSTOM_KERNEL_04_SUB_IMGSENSOR = 
CUSTOM_KERNEL_05_IMGSENSOR = 
CUSTOM_KERNEL_ACCELEROMETER = mxc400x
CUSTOM_KERNEL_ALSPS = stk3x1x_s35
...
CUSTOM_KERNEL_IMGSENSOR = ov13850_mipi_raw_s35_sunwin ov5670_mipi_raw_s35 gc2355_mipi_raw_s35
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = hx8394d_hd720_dsi_vdo_s35 otm1287_hd720_dsi_vdo_boyi_s35
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dummy_lens fm50af dw9718af
CUSTOM_KERNEL_MAGNETOMETER = 
CUSTOM_KERNEL_MAIN2_IMGSENSOR = 
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = 
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dummy_lens
CUSTOM_KERNEL_MAIN_IMGSENSOR = ov13850_mipi_raw_s35_sunwin
CUSTOM_KERNEL_MAIN_LENS = fm50af dw9718af
CUSTOM_KERNEL_REMOTE_CTRL = mc96fr116c_s35
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SSW = ssw_single
CUSTOM_KERNEL_SUB2_IMGSENSOR = 
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR = gc2355_mipi_raw_s35
CUSTOM_KERNEL_SUB_BACKUP_LENS = dummy_lens
CUSTOM_KERNEL_SUB_IMGSENSOR = ov5670_mipi_raw_s35
CUSTOM_KERNEL_SUB_LENS = 
CUSTOM_KERNEL_TOUCHPANEL = GT915M_S35
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_LED_INDICATOR_SUPPORT = yes
CUSTOM_LK_LCM = hx8394d_hd720_dsi_vdo_s35 otm1287_hd720_dsi_vdo_boyi_s35
CUSTOM_MODEM = s3598_modem
CUSTOM_MTP_NAME = P55 Novo
CUSTOM_PRELOADER_CUSTOM = custom
CUSTOM_PRODUCT_BOARD = Panasonic
CUSTOM_PRODUCT_MANUFACTURER = PANASONIC
CUSTOM_PRODUCT_MODEL = Panasonic P55 Novo
CUSTOM_PRODUCT_NAME = P55_Novo
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_TARGET_BRAND = Panasonic
CUSTOM_TARGET_DEVICE = P55_Novo
CUSTOM_TARGET_PRODUCT = s3569_karbonn
CUSTOM_UBOOT_LCM = hx8394d_hd720_dsi_vdo_s35 otm1287_hd720_dsi_vdo_boyi_s35
CUSTOM_VERSION = EB-90S53P55v1027
CUST_ALIGNED_WAKEUP_SUPPORT = yes
CUST_APPMANAGER_SUPPORT = yes
CUST_AUTO_CALL_RECORDER = yes
CUST_AUTO_SPEAKER_ON_SUPPORT = yes
CUST_CALLER_ID_SUPPORT = no
CUST_CAMERA_GRADIENTER_SUPPROT = yes
CUST_CAMERA_SELF_PREVIEW_SUPPORT = yes
CUST_COCO_KEYGUARD_SUPPORT = no
CUST_COMPASS_LIVE_WALLPAPER_SUPPORT = no
CUST_COMPASS_SUPPORT = no
CUST_COUNTRY_CODE_MATCHING_SUPPORT = yes
CUST_COVER_SUPPORT = no
CUST_DEFAULT_DATA_ROAMING_ENABLE = no
CUST_DEWAV_CTS_SUPPORT = yes
CUST_DEWAV_DIY_THEME = yes
CUST_DEWAV_HEALTH = yes
CUST_DEWAV_MULTI_GESTURE_SUPPORT = yes
CUST_DEWAV_OTG_SUPPORT = no
CUST_DEWAV_SMART_SAVER = no
CUST_DEWAV_SMART_WAKE = yes
CUST_DEWAV_SMART_WAKE_MULTI_TP = no
CUST_DEWAV_TEST_MODE_SUPPORT = yes
CUST_DEWAV_THEME = yes
CUST_DWGESTURE_SUPPORT = yes
CUST_DW_BOARD_TEST = no
CUST_DW_DATA_FIREWALL_SUPPORT = no
CUST_FACTORY_AUTO_RESET = yes
CUST_FIREWALL_SUPPORT = no
CUST_FLASHLIGHT_SUPPORT = yes
CUST_FLIP_MUTE_SUPPORT = no
CUST_FLOAT_CALL_SUPPORT = yes
CUST_GLOBAL_ACTION_SCREENSHOT_SUPPORT = yes
CUST_GPRS_ON_DEFAULT = no
CUST_GSENSOR_3AXES_SUPPORT = no
CUST_HIDE_NAVIGATION_BAR_SUPPORT = yes
CUST_HIDE_SIM_INDICATOR_WHEN_NONSIM = no
CUST_HLL_ELAUNCHER_SUPPORT = yes
CUST_HLL_FILEMANAGER_SUPPORT = yes
CUST_INCALL_5S_SCREEN_OFF_SUPPORT = no
CUST_INDEX_ZONE_SUPPORT = yes
CUST_IP_DIAL_SUPPORT = no
CUST_KEYGUARD_SWIPE_UNLOCK = no
CUST_LAUNCHER3_SUPPORT = yes
CUST_MEM_CLEAR_SUPPORT = no
CUST_MIRROR_SUPPORT = yes
CUST_MMSSMS_ENCRYPTION_SUPPORT = yes
CUST_MMS_CALLING_OUT_IMMEDIATELY_SUPPORT = no
CUST_MULTI_COLOR_DEFAULT_CONTACT_PHOTO = yes
CUST_NAVIGATION_BAR_SETTINGS = yes
CUST_NON_SPACE_IN_PHONE_NUMBER_SUPPORT = no
CUST_NOTIFICATION_LIGHT_OFF_IN_CHARGING = no
CUST_OWS_SUPPORT = no
CUST_PARTIAL_SCREENSHOT_SUPPORT = yes
CUST_QUICK_LOCK_SCREEN = yes
CUST_REMOTE_CTRL_SUPPORT = no
CUST_SMART_INSTALL = no
CUST_SMART_IR_SUPPORT = yes
CUST_STK_HEART_RATE_SUPPORT = yes
CUST_SUPER_POWER_SUPPORT = no
CUST_SYNC_AUTOMATIC_SUPPORT = yes
CUST_SYNC_ERROR_AVOID_SUPPORT = yes
CUST_TIME_WIDGET2_SUPPORT = yes
CUST_TYPE_ICON_GEMINI_HIDE = no
CUST_WEATHER_FORECAST = no
CUST_WIFI_HOTSPOT_ALWAYS_ON = no
...
EVDO_IR_SUPPORT = no
FACTORY_CUSTOMIZE = __FACTORY_CUSTOMIZE__
FACTORY_CUSTOMIZE_KEYS = __FACTORY_CUSTOMIZE_KEYS_
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = S3569_DS35691_KARBONN_L103
MTK_BWC_SUPPORT = yes
...
MTK_PRODUCT_LOCALES = en_US en_GB hi_IN ja_JP fr_FR de_DE it_IT ru_RU zh_CN ar_IL bn_IN th_TH af_ZA ar_IL zh_TW en_IN tl_PH in_ID fa_IR pt_PT es_ES sw_TZ ur_PK vi_VN zu_ZA nl_BE nl_NL pl_PL tr_TR uk_UA gu_IN mr_IN pa_IN
